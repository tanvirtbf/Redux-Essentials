...
})({"925Et":[function(require,module,exports) {
...
console.log(store);
store.dispatch((0, _cartReducer.cartAddItem)(1, 2));
store.dispatch((0, _cartReducer.cartAddItem)(2, 3));
store.dispatch((0, _cartReducer.cartAddItem)(3, 5));
store.dispatch((0, _cartReducer.cartAddItem)(4, 8));
store.dispatch((0, _cartReducer.cartRemoveItem)(3));
store.dispatch((0, _cartReducer.cartIncreaseItem)(2, 3));
store.dispatch((0, _cartReducer.cartdecreaseItem)(2, 4));
store.dispatch((0, _wishListReducer.wishListAddItem)(1, 2));
store.dispatch((0, _wishListReducer.wishListAddItem)(2, 4));
store.dispatch((0, _wishListReducer.wishListAddItem)(3, 1));
...
},{"redux":"anWnS","./productsReducer":"9nz3D","@parcel/transformer-js/src/esmodule-helpers.js":"cskQC","./wishListReducer":"eKMDw","./cartReducer":"96Hwp"}],"anWnS":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"cskQC"}],"cskQC":[function(require,module,exports) {
...
parcelHelpers.export(exports, "cartIncreaseItem", ()=>cartIncreaseItem);
parcelHelpers.export(exports, "cartdecreaseItem", ()=>cartdecreaseItem);
...
function cartIncreaseItem(productId, quantity) {
    return {
...
function cartdecreaseItem(productId, quantity) {
    return {
