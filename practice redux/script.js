...
store.dispatch({type: WISHLIST_ADD_ITEM, payload: {productId: 1, quantity: 2}})
store.dispatch({type: WISHLIST_ADD_ITEM, payload: {productId: 2, quantity: 3}})
store.dispatch({type: WISHLIST_ADD_ITEM, payload: {productId: 3, quantity: 5}})
store.dispatch({type: WISHLIST_ADD_ITEM, payload: {productId: 4, quantity: 6}})
